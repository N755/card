...
#Чому коли я хочу зробити 4 пробіли біля card1,card2,card3,card4,card5 стає не активною назва класу після = ?
...
class BusinessContact(BaseContact): 
    def __init__(self, first_name, last_name, company, job, email, phone_number, job_phone_number ):
